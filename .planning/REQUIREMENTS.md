...
- [ ] **DVL-01**: User can download a voltage level node from ServerTree to ClientTree
- [ ] **DVL-02**: Download includes full ancestor chain (Organisation → Substation → VoltageLevel)
- [ ] **DVL-03**: If node exists in ClientTree, overwrite with server data
- [ ] **DVL-04**: User can trigger download via toolbar button
- [ ] **DVL-05**: Download shows success/error message after completion
- [ ] **DVL-06**: ClientTree refreshes to show downloaded nodes after completion
...
|-------------|-------|--------|
| DVL-01 | Phase 1 | Pending |
| DVL-02 | Phase 1 | Pending |
| DVL-03 | Phase 1 | Pending |
| DVL-04 | Phase 1 | Pending |
| DVL-05 | Phase 1 | Pending |
| DVL-06 | Phase 1 | Pending |
