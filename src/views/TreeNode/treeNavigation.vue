...
import deleteData from './Client/ClientSide/mixin/deleteData'
import showAddBay from './Client/ClientSide/mixin/showAddBay'
import showAddBushing from './Client/ClientSide/mixin/showAddBushing'
import showAddCapacitor from './Client/ClientSide/mixin/showAddCapacitor'
import showAddCircuitBreaker from './Client/ClientSide/mixin/showAddCircuitBreaker'
import showAddConnector from './Client/ClientSide/mixin/showAddConnector'
import showAddCt from './Client/ClientSide/mixin/showAddCt'
import showAddJob from './Client/ClientSide/mixin/showAddJob'
import showAddOrganisation from './Client/ClientSide/mixin/showAddOrganisation'
import showAddPowerCable from './Client/ClientSide/mixin/showAddPowerCable'
import showAddReactor from './Client/ClientSide/mixin/showAddReactor'
import showAddRotatingMachine from './Client/ClientSide/mixin/showAddRotatingMachine'
import showAddSubInTree from './Client/ClientSide/mixin/showAddSubInTree'
import showAddSubs from './Client/ClientSide/mixin/showAddSubs'
import showAddSurgeArrester from './Client/ClientSide/mixin/showAddSurgeArrester'
import showAddTransformer from './Client/ClientSide/mixin/showAddTransformer'
import showAddVt from './Client/ClientSide/mixin/showAddVt'
import showAddVoltageLevel from './Client/ClientSide/mixin/showAddVoltageLevel'
...
export default {
    ...
    showAddTransformer, showAddVt, showAddVoltageLevel, showLocationRoot, ],
    async beforeMount() {
        try {
