<template>
    <div class="rm-property-wrap">
        <div class="rm-row property">
            ...
            <div class="col-content">
                <section class="rm-card rm-comment-card">
                    <div class="rm-header">
                        <i class="fa-solid fa-align-left"></i>
                        <span>Comment</span>
                    </div>
                    <div class="rm-body">
                        <el-form :label-width="labelWidth" size="mini" label-position="left" class="rm-comment-form">
                            <el-input class="rm-comment-input" type="textarea" v-model="propertiesData.comment"></el-input>
                        </el-form>
                    </div>
                </section>
            </div>
        ...
        <div class="rm-row property">
            ...
            <div class="col-content">
                <Attachment class="rm-attach-card" :attachment_="this.attachmentData" title="substation" height="230px"
...
.rm-comment-form,
.rm-comment-input,
.rm-comment-input ::v-deep(.el-textarea__inner) {
    height: 100%;
}
