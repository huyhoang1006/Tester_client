<template>
    <div id="ratings" class="mgy-5">
        ...
        <div class="content-toggle" v-if="openRatings">
            ...
            <el-row v-if="ratingsData.standard.value != 'selectStandard'">
                <br />
            ...
            <el-row v-if="openShow && ratingsData.standard.value != 'IEEEC5713'"
                style="width: 100%; background-color: #F5F5F5; border: 1px solid black;" class="content">
            ...
            <el-row v-if="openShow && ratingsData.standard.value == 'IEEEC5713'"
                ...
                <el-row class="rating_content">
                    <el-col :span="8" class="col-content">
                        <el-form :inline-message="true" :label-width="labelWidth" size="mini" label-position="left">
                            <el-form-item label="Primary windings">
                                <el-col :span="24" class="pdr-0">
                                    <el-select style="width: 45%;" v-model="ratingsData.primary_winding_count">
                                        <el-option label="1" value="1"></el-option>
                                        <el-option label="2" value="2"></el-option>
                                        <el-option label="4" value="4"></el-option>
                                    </el-select>
                ...
                <el-row class="ith_content">
                    <el-col :span="10" class="col-content">
                        <el-form :inline-message="true" :label-width="labelWidth" size="mini" label-position="left">
                            <el-form-item label="System voltage">
                                <el-input v-model="ratingsData.system_voltage.value">
                                    <template slot="append">V</template>
                                </el-input>
                            </el-form-item>
                        </el-form>
                    ...
                    <el-col :span="6" class="col-content">
                        <el-form :inline-message="true" label-width="100px" size="mini" label-position="left">
                            <el-form-item label="">
                                <el-select v-model="ratingsData.system_voltage_type.value">
                    ...
                    <el-col :span="10" class="col-content">
                        <el-form :inline-message="true" :label-width="labelWidth" size="mini" label-position="left">
                            <el-form-item label="Rated insulation level (BIL)">
                                <el-input v-model="ratingsData.bil.value">
                                    <template slot="append">V</template>
                                </el-input>
                            </el-form-item>
                        </el-form>
            ...
            <el-row v-if="ratingsData.standard.value == 'IEEEC5713'" style="margin-bottom: 20px; margin-top: 20px;">
                <el-col :span="4">
                ...
                <el-col :span="8">
                    <el-row>
                        <el-col :span="8">
                            <el-select size="mini" v-model="ratingsData.rating_factor">
                        ...
                        <el-col :span="8">
                            <el-input size="mini" v-model="ratingsData.rating_factor_temp.value">
