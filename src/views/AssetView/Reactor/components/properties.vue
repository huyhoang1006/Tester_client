<template>
    <div id="properties" class="rx-property-wrap">
        <div class="rx-row property">
            ...
            <div class="col-content">
                <section class="rx-card rx-comment-card">
                    <div class="rx-header">
                        <i class="fa-solid fa-align-left"></i>
                        <span>Comment</span>
                    </div>
                    <div class="rx-body">
                        <el-form :label-width="labelWidth" size="mini" label-position="left" class="rx-comment-form">
                            <el-input class="rx-comment-input" type="textarea" v-model="propertiesData.comment"></el-input>
                        </el-form>
                    </div>
                </section>
            </div>
        ...
        <div class="rx-row property">
            ...
            <div class="col-content">
                <Attachment class="rx-attach-card" :attachment_="this.attachmentData" title="reactor" height="230px"
...
.rx-comment-form,
.rx-comment-input,
.rx-comment-input ::v-deep(.el-textarea__inner) {
    height: 100%;
}
