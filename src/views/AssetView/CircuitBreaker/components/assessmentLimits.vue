                        ...
                        <table class="table-strip-input-data" style="width: 100% !important;">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                    ...
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.trip_operation.abs[item.value].t_min.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.trip_operation.abs[item.value].t_max.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                </tr>
                        ...
                        <table class="table-strip-input-data" style="width: 100% !important;">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                    ...
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.trip_operation.rel[item.value].t_ref.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.trip_operation.rel[item.value].t_dev.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                </tr>
                        ...
                        <table class="table-strip-input-data" style="width: 100% !important;">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                    ...
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.close_operation.abs[item.value].t_min.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.close_operation.abs[item.value].t_max.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                </tr>
                        ...
                        <table class="table-strip-input-data" style="width: 100% !important;">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                    ...
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.close_operation.rel[item.value].t_ref.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.auxiliary_contacts.close_operation.rel[item.value].t_dev.value">
                                            <template slot="append">ms</template>
                                        </el-input>
                                    </td>
                                </tr>
                        ...
                        <table class="table-strip-input-data" style="width: 100% !important;">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in coilCharacteristics" :key="index">
                                    ...
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.coil_characteristics.rel[item.value].minus_dev.value">
                                            <template v-if="index <= 3" slot="append">A</template>
                                            <template v-else-if="3 < index && index <= 5" slot="append">V</template>
                                            <template v-else slot="append">&#8486;</template>
                                        </el-input>
                                    ...
                                    <td>
                                        <el-input size="mini" type="text" number="positive"
                                            v-model="assessLimitsData.coil_characteristics.rel[item.value].plus_dev.value">
                                            <template v-if="index <= 3" slot="append">A</template>
                                            <template v-else-if="3 < index && index <= 5" slot="append">V</template>
                                            <template v-else slot="append">&#8486;</template>
                                        </el-input>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.under_voltage_release.abs.uv_coil_trip_voltage.min.value">
                                        <template slot="append">V</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.under_voltage_release.abs.uv_coil_trip_voltage.max.value">
                                        <template slot="append">V</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.under_voltage_release.rel.uv_coil_trip_voltage.ref.value">
                                        <template slot="append">V</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.under_voltage_release.rel.uv_coil_trip_voltage.dev.value">
                                        <template slot="append">V</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.overcurrent_release.abs.oc_replay_trip_current.min.value">
                                        <template slot="append">A</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.overcurrent_release.abs.oc_replay_trip_current.max.value">
                                        <template slot="append">A</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.overcurrent_release.rel.oc_replay_trip_current.ref.value">
                                        <template slot="append">A</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="mini" type="text" number="positive"
                                        v-model="assessLimitsData.overcurrent_release.rel.oc_replay_trip_current.dev.value">
                                        <template slot="append">A</template>
                                    </el-input>
                                </td>
                            </tr>
