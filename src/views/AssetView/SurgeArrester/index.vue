        ...
        <div>
            <el-row :gutter="20" id="main-content" style="padding: 0; z-index: 0;">
                <el-tabs type="card" class="w-100 h-100">
                    <el-tab-pane label="Surge Arrester">
                        <surgeArresterProperty @setUpdate="setUpdate" :updateNew='updateNew' :update="update" @editManu="editManu" :title="title" :properties.sync="properties" @createAdd="updateShowAdd" :manufact="manufacturerCustom" @reloadManu="reloadManu()"></surgeArresterProperty>
...
import surgeArresterProperty from './components/properties.vue'
import manufacturerAdd from '@/views/Common/ManufacturerAdd.vue'
export default {
    name: 'surgeArrester',
    components: {
        surgeArresterProperty,
        ratings,
        manufacturerAdd
    },
    data() {
