        ...
        <el-row :gutter="20" style="padding: 0">
            <el-tabs type="card">
                ...
                <el-tab-pane>
                    ...
                    <div>
                        <testing-equipment :data="reactorJobDto.testingEquipmentData" :test-list="reactorJobDto.testList"></testing-equipment>
                    </div>
                </el-tab-pane>
                        ...
                        <el-tabs v-model="objActiveName.activeName" type="card" class="w-100 h-100">
                            <el-tab-pane v-for="(item, index) in reactorJobDto.testList" :key="index" :label="item.name" :name="item.name + index">
                                <test-information
                                    ...
                                    compare-asset-kind="Reactor"
                                    :compare-asset-mrid="reactorJobDto.properties.asset_id"
                                    :compare-exclude-work-mrid="reactorJobDto.properties.mrid">
                                </test-information>
                                <component
...
import compareTestMap from '@/config/test-definitions/Reactor'
