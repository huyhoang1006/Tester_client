...
export default {
    ...
    methods: {
        ...
        getRatedVoltage() {
            ...
            var rating = voltageRatings.find(function(item) { return item.winding === this.$constant.TERT }.bind(this))
            return this.measurementToBase(rating && rating.voltage_ll, 'V')
        },
        getReferenceUk(tap) {
            var impedances = (this.assetData && this.assetData.impedances && this.assetData.impedances.prim_tert) || []
