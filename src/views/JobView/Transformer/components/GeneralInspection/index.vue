            ...
            <tbody>
                <template v-for="(item, index) in testData.table" >
                    <tr :key="index">
                        ...
                        <td>
                            <el-input size="mini" type="text" v-model="item.test_object.value" v-if="item.test_object"></el-input>
                        </td>
                        <td>
                        ...
                        <td>
                            <el-input :class="nameColor(item.condition_indicator && item.condition_indicator.value)" id="condition" type="text" size="mini" v-model="item.condition_indicator.value" v-if="item.condition_indicator">
                            </el-input>
                        </td>
                        <td>
    ...
    methods: {
        ...
        clear() {
            this.testData.table.forEach((element) => {
                if (element.test_object) element.test_object.value = ''
