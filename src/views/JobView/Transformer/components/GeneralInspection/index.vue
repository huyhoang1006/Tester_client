<template>
    <div id="general-inspection" class="test-ui" style="width: 100%; font-size: 12px;">
        <!-- Cấu hình -->
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(transformerTestMap['GeneralInspection'].columns) },
