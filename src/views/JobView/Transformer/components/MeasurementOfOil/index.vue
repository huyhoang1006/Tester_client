<template>
    <div>
        ...
        <table class="mgb-10 table-strip-input-data test-table">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <el-select size="mini" allow-create filterable :reserve-keyword="false"
        ...
        <table class="table-strip-input-data test-table">
                ...
                <tbody>
                    <tr>
                        <td>≥ <el-input size="mini" class="w-100px"
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(transformerTestMap['MeasurementOfOil'].columns) },
