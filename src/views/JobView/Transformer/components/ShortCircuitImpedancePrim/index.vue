        ...
        <table class="table-strip-input-data test-table">
            ...
            <tbody v-if="currentOption === 'threePhase'" key="three">
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td><el-input size="mini" type="text" v-model="item.tap.value"></el-input></td>
                    <td style="width: 10%">
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(transformerTestMap['ShortCircuitImpedancePrim'].columns) },
    ...
    methods: {
        ...
        getRatedVoltage() {
            ...
            var rating = voltageRatings.find(function(item) { return item.winding === this.$constant.PRIM }.bind(this))
            return this.measurementToBase(rating && rating.voltage_ll, 'V')
        },
        getReferenceUk(tap) {
            var impedances = (this.assetData && this.assetData.impedances && this.assetData.impedances.prim_sec) || []
