        ...
        <table class="table-strip-input-data" style="width: 80%">
            <thead>
                <tr>
                    ...
                    <th rowspan="2">Test voltage (V)</th>
                    <th colspan="2">R meas (MΩ)</th>
                    <th rowspan="2" class="assessment-col">Assessment</th>
                    <th rowspan="2" class="condition-indicator-col">Condition indicator</th>
                    <th rowspan="2" @click="add()" class="action-col"><i class="fa-solid fa-plus pointer"></i></th>
                    <th rowspan="2" @click="removeAll()" class="action-col"><i class="fa-solid fa-trash pointer"></i></th>
                </tr>
                <tr>
                    <th>Before HV test</th>
                    <th>After HV test</th>
                </tr>
            </thead>
            <tbody>
                <template v-for="(item, index) in testData.table">
                    <tr :key="index">
                        ...
                        <td>
                            <el-input size="mini" type="text" v-model="item.beforeHv.value"></el-input>
                        </td>
                        <td>
                            <el-input size="mini" type="text" v-model="item.afterHv.value"></el-input>
                        </td>
                        <td>
