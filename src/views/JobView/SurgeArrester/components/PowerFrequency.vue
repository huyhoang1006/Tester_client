                ...
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td :rowspan="phaseGroupSize()" v-if="isPhaseGroupStart(index)">
                        <div class="phase-cell">
                            ...
                            <div :class="phaseColorClass(item.phase.value)" class="phase-color">
                            </div>
                        </div>
                    </td>
                    <td :class="unitShow">
                    ...
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.ref_current.value"></el-input>
                    </td>
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.v_meas.value"></el-input>
                    </td>
                    <td>
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(surgeArresterTestMap['PowerFrequency'].columns) },
...
.assessment-container { width: min(100%, 720px); border: 1px solid #ddd; border-radius: 6px; margin-bottom: 16px; overflow: hidden; }
