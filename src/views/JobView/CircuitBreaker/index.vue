        ...
        <el-row :gutter="20" style="padding: 0">
            <el-tabs type="card">
                ...
                <el-tab-pane>
                    ...
                    <div>
                        <testing-equipment :data="circuitBreakerJobDto.testingEquipmentData" :test-list="circuitBreakerJobDto.testList"></testing-equipment>
                    </div>
                </el-tab-pane>
                        ...
                        <el-tabs v-model="objActiveName.activeName" type="card" class="w-100 h-100">
                            <el-tab-pane v-for="(item, index) in circuitBreakerJobDto.testList" :key="index" :label="item.name" :name="item.name + index">
                                <test-information
                                    ...
                                    compare-asset-kind="CircuitBreaker"
                                    :compare-asset-mrid="circuitBreakerJobDto.properties.asset_id"
                                    :compare-exclude-work-mrid="circuitBreakerJobDto.properties.mrid">
                                </test-information>
                                <component
...
import compareTestMap from '@/config/test-definitions/CircuitBreaker'
