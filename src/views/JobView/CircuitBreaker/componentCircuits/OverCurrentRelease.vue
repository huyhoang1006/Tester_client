            ...
            <tbody>
                <template v-for="(item, index) in testData.table">
                    <tr :key="index">
                        ...
                        <td>
                            <el-input size="mini" style="width: 100px;" type="text" v-model="item.tripCoilNo.value"></el-input>
                        </td>
                        <td>
                            <el-input size="mini" type="text" v-model="item.tripCurrent.value"></el-input>
                        </td>
                        <td>
