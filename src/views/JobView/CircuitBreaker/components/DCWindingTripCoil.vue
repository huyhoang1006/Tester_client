        ...
        <el-dialog append-to-body title="Assessment settings" :visible.sync="openAssessmentDialog" width="500px">
            ...
            <el-form size="small" label-position="left" label-width="140px">
                <template v-if="assetData.assessmentLimits.limits === 'Absolute'">
                    <el-form-item label="Minimum (Ω)"><el-input v-model="assetData.assessmentLimits.coil_characteristics.abs.trip_coil_resistance.min.value"/></el-form-item>
                    <el-form-item label="Maximum (Ω)"><el-input v-model="assetData.assessmentLimits.coil_characteristics.abs.trip_coil_resistance.max.value"/></el-form-item>
                </template>
                <template v-else>
                    <el-form-item label="Reference (Ω)"><el-input v-model="assetData.assessmentLimits.coil_characteristics.rel.trip_coil_resistance.ref.value"/></el-form-item>
                    <el-form-item label="- Deviation (Ω)"><el-input v-model="assetData.assessmentLimits.coil_characteristics.rel.trip_coil_resistance.minus_dev.value"/></el-form-item>
                    <el-form-item label="+ Deviation (Ω)"><el-input v-model="assetData.assessmentLimits.coil_characteristics.rel.trip_coil_resistance.plus_dev.value"/></el-form-item>
                </template>
            </el-form>
...
export default {
    ...
    data() {
        return {
            ...
            assessmentSectionKeys: ['trip_coil_resistance'],
    ...
    methods: {
        ...
        calculator() {
            ...
            this.testData.table.table1.forEach(function(item) {
                ...
                var result
                if (mode === 'Absolute') {
                    result = this.assessAbsolute(value, cc.abs.trip_coil_resistance.min, cc.abs.trip_coil_resistance.max)
                } else {
                    result = this.assessRelativeAsym(value, cc.rel.trip_coil_resistance.ref, cc.rel.trip_coil_resistance.minus_dev, cc.rel.trip_coil_resistance.plus_dev)
                }
