        ...
        <el-row :gutter="20" style="padding: 0">
            <el-tabs type="card">
                ...
                <el-tab-pane style="width: 100%;">
                    ...
                    <overview :data="capacitorJobDto.properties" @update-attachment="updateAttachmentOverView" :attachment.sync="capacitorJobDto.attachmentData" :locationData="locationData" :assetData="assetData" :productAssetModelData="productAssetModelData" :parentOrganization="parentOrganization"></overview>
                </el-tab-pane>
                ...
                <el-tab-pane>
                    ...
                    <div>
                        <testing-equipment :data="capacitorJobDto.testingEquipmentData" :test-list="capacitorJobDto.testList"></testing-equipment>
                    </div>
                </el-tab-pane>
                ...
                <el-tab-pane>
                    ...
                    <div id="tests" style="width: 100%;">
                        <el-tabs v-model="objActiveName.activeName" type="card" class="w-100 h-100">
                            <el-tab-pane v-for="(item, index) in capacitorJobDto.testList" :key="index" :label="item.name" :name="item.name + index">
                                <test-information
                                    :title="item.name"
