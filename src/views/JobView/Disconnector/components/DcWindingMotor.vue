        ...
        <table class="table-strip-input-data" style="width: 80%">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td><el-input size="mini" type="text" number="positive" v-model="item.r_meas.value" v-if="item.r_meas"/></td>
                    <td>
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(disconnectorTestMap['DcWindingMotor'].columns) },
