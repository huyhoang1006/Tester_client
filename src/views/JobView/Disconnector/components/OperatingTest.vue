                    ...
                    <tr v-for="(item, index) in testData.table.table1" :key="index">
                        <td>
                            <div style="display: flex;width: 100%;">   
                                <el-input style="width: 105px;" size="mini" type="text" v-model="item.measurement.value" v-if="item.measurement"></el-input>
                                <div :class="{colorTableRed : index%3==0, colorTableYellow : index%3==1, colorTableBlue : index%3==2}"></div>
                            </div>
                        </td>
                        <td>
                            <el-input size="mini" type="text" v-model="item.working_time.value" v-if="item.working_time"></el-input>
                        </td>
                        <td>
        ...
        clear() {
            if (this.testData.table && this.testData.table.table1) {
                this.testData.table.table1.forEach((element) => {
                    ...
                    if (element.working_time) element.working_time.value = ""
