                    ...
                    <tr v-for="(item, index) in testData.table.table1" :key="index">
                        <td>
                            <div style="display: flex;width: 100%;">
                                <el-input style="width: 105px;" size="mini" type="text" v-model="item.measurement.value"
                        ...
                        <td>
                            <el-input size="mini" type="text" number="positive" v-model="item.working_time.value"
