                ...
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <div style="display: flex;width: 100%;">
                            <el-input style="width: 100x;" size="mini" type="text" v-model="item.measurement.value"
                    ...
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.i_test.value" v-if="item.i_test"></el-input>
                    </td>
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.contact_resistance.value"
                    ...
                    <td>
                        <el-select :class="nameColor(item.condition_indicator && item.condition_indicator.value)"
                            id="condition" type="text" size="mini" disabled v-model="item.condition_indicator.value"
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(disconnectorTestMap.ContactResistance.columns) },
