...
export default {
    ...
    methods: {
        ...
        checkTestingEquipment(data) {
            ...
            for (const disconnector of arr) {
                const existed = data.disconnectorTestingEquipmentTestType.some(
                    old =>
                        old.testing_equipment_id === disconnector.testing_equipment_id &&
                        old.test_type_id === disconnector.test_type_id
                );
                if (!existed) {
                    data.disconnectorTestingEquipmentTestType.push(disconnector);
                }
            }
