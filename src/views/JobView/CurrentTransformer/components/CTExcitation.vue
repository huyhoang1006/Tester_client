...
export default {
    ...
    computed: {
        ...
        rowData() {
            return common.buildEmptyTestRow(currentTransformerTestMap['CTExcitation'].columns)
        },
        assessmentData() {
        ...
        'option': {
            ...
            handler: async function (newVal) {
                ...
                common.ensureAssessmentData(
                    this.testAssessment,
                    newVal,
                    currentTransformerAssessmentMap['CTExcitation']  // ← đổi testCode theo từng file
                )
...
.assessment-header {
    ...
    font-weight: bold;
    font-size: 13px;
    padding: 8px 12px;      // ← đồng bộ với limit-col padding
    border-bottom: 1px solid #ebeef5;
}

.assessment-body {
    display: flex;
    flex-direction: column; // ← thêm cái này
    // padding: 10px;       // ← bỏ padding này đi, để tree-row tự padding
