<template>
    <div class="vt-test">
        ...
        <table class="table-strip-input-data test-table">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.c_ref.value"
                    ...
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.c_meas.value"
                            @input="calcRowDeltaC(item)"></el-input>
                    </td>
                    <td>
                        <el-input size="mini" type="text" number="positive"
                            v-model="item.delta_c_percent.value" readonly></el-input>
                    </td>
                    <td>
        ...
        <el-dialog :modal=true title="Condition indicator settings" :visible.sync="openConditionIndicatorDialog" width="min(860px, 92vw)"
            append-to-body>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(voltageTransformerTestMap['VTDfcap'].columns) },
