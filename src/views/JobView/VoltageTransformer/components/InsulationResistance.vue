<template>
    <div class="ir-test">
        ...
        <table class="table-strip-input-data test-table">
            ...
            <thead>
                <tr>
                    ...
                    <th @click="add()" class="action-col th-btn" title="Add row"><i
                            class="fa-solid fa-plus pointer"></i></th>
                    <th @click="removeAll()" class="action-col th-btn th-btn-danger" title="Remove all"><i
                            class="fa-solid fa-trash pointer"></i></th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td class="cell-center">
                        <el-button size="mini" type="primary" class="row-btn" @click="addTest(index)"
                            title="Insert row below">
                            <i class="fa-solid fa-plus"></i>
                        </el-button>
                    </td>
                    <td class="cell-center">
                        <el-button size="mini" type="danger" class="row-btn" @click="deleteTest(index)"
                            title="Delete row">
        ...
        <!-- Assessment settings -->
        <el-dialog title="Assessment settings" :visible.sync="openAssessmentDialog" width="min(860px, 92vw)"
            append-to-body>
            <el-form size="small" label-position="left" label-width="140px">
                <el-form-item label="Option">
                    <el-select style="width: 100%; max-width: 420px;" size="mini" placeholder="please select"
                        v-model="option">
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(voltageTransformerTestMap['InsulationResistance'].columns) },
