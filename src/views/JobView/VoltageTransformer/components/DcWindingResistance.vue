        ...
        <table class="table-strip-input-data test-table">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="mini" type="text" number="positive" v-model="item.r_dev.value" readonly></el-input>
                    </td>
                    <td>
...
export default {
    ...
    computed: {
        ...
        rowData()      { return common.buildEmptyTestRow(voltageTransformerTestMap['DcWindingResistance'].columns) },
    ...
    methods: {
        ...
        async calcRcorr() {
            ...
            for(const item of this.testData.table.table1) {
