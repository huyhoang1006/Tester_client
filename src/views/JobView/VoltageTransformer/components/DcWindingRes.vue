            ...
            <tbody>
                <template v-for="(item, index) in testData.table">
                    <tr :key="index">
                        ...
                        <td>
                            <el-input size="mini" type="text" v-model="item.rref"></el-input>
                        </td>
                        <td>
                            <el-input size="mini" type="text" v-model="item.rcorr"></el-input>
                        </td>
                        <td>
                            <el-input size="mini" type="text" v-model="item.rdev"></el-input>
                        </td>
                        <td>
