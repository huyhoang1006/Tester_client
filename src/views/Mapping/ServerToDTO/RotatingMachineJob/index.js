...
const TF_DISCRETE_ALIAS_TO_VALUE = (() => {
    ...
    collect(rotatingMachineTestMap)
    collect(rotatingMachineConditionMap)
    return map
})()
...
// ═══════════════════════════════════════════════════════════════════════════════
// Mapper: DTO Job (Rotating Machine) → server JSON (upload)
//
...
export const mapServerToDto = (server) => {
    ...
    return {
        ...
        rotatingMachineTestingEquipmentTestType: (server.testingEquipmentData || server.testingEquipmentList || [])
