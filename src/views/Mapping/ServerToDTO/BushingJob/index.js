...
const TF_DISCRETE_ALIAS_TO_VALUE = (() => {
    ...
    collect(bushingTestMap)
    collect(bushingConditionMap)
    return map
})()
...
// ═══════════════════════════════════════════════════════════════════════════════
// Mapper: DTO Job (Bushing) → server JSON (upload)
//
...
export const mapServerToDto = (server) => {
    ...
    return {
        ...
        bushingTestingEquipmentTestType: (server.testingEquipmentData || server.testingEquipmentList || [])
