/* eslint-disable */
import CircuitBreakerJobEntity from "@/views/Entity/Job/CircuitBreaker"
...
import CircuitBreakerTestType from "@/views/Entity/CircuitBreakerTestType";
...
export const jobDtoToEntity = (dto) => {
    ...
    for (const circuitBreakerTestingEquipmentTestType of dto.circuitBreakerTestingEquipmentTestType) {
        const data = new CircuitBreakerTestType();
