    ...
    <div class="rep">
        ...
        <div class="timeline">
            <div v-for="(r, i) in records" :key="i" class="tl-card" :class="{ closed: r.status === 'Completed' }">
                ...
                <input class="tl-title" v-model="r.reason" placeholder="Fault description" />
                <div class="tl-meta">
                    <div class="tm">
...
<style scoped>
.rep { --blue-900:#0b2f86; --blue-800:#123c9c; --gray-900:#111827; --gray-700:#374151; --gray-600:#4b5563; --gray-500:#6b7280; --gray-400:#9ca3af; --gray-300:#d1d5db; --gray-200:#e5e7eb; --gray-100:#f3f4f6; }
...
.tl-card { border: 1px solid var(--gray-200); border-left: 4px solid #ea580c; border-radius: 10px; padding: 14px; background: #fff; }
...
.tl-title { width: 100%; border: none; background: transparent; font-size: 15px; font-weight: 800; color: var(--gray-900); outline: none; margin-bottom: 12px; }
