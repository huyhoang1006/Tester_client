...
export const downloadAssetMedia = (assetType, assetId, mediaId) => {
    return client.get(`/${prefix}/${assetType}/${toServerId(assetId)}/media/${toServerId(mediaId)}/download`, {
        responseType: 'blob',
    })
}
...
export const deleteAssetMedia = (assetType, assetId, mediaId) => {
    return client.delete(`/${prefix}/${assetType}/${toServerId(assetId)}/media/${toServerId(mediaId)}`)
}
